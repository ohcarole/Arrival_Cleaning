...
# find instances where one has date and other does not
induction  <- induction_ # reset in case I am debugging

date_cols  <- compare_col_types(allarrival, induction, target_class = "Date") 
allarrival <- allarrival |> mutate(across(any_of(date_cols), as.Date))
induction  <- induction  |> mutate(across(any_of(date_cols), as.Date))
